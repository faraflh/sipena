        ...
        <div class="card-header pb-0 p-3">
            <div class="row">
                ...
                <div class="col-6 text-end">
                    <button class="btn bg-gradient-dark mb-0" data-bs-toggle="modal" data-bs-target="#createDokumenModal">
                                    ...
                                    <form action="{{ route('dokumen.update', $doc->id) }}" method="POST">
                                        ...
                                        <div class="modal-body">
                                            <div class="mb-3">
                                                ...
                                                <select name="idKategori" class="form-control" required>
                                                    @foreach($kategori as $k)
                                                        <option value="{{ $k->id }}" {{ $doc->idKategori == $k->id ? 'selected' : '' }}>
                                                            {{ $k->namaKategori }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <select name="idAlur" class="form-control" required>
                                                    @foreach($alur as $a)
                                                        <option value="{{ $a->id }}" {{ $doc->idAlur == $a->id ? 'selected' : '' }}>
                                                            {{ $a->namaAlur }}
                                                        </option>
                                                    @endforeach
                                                </select>
