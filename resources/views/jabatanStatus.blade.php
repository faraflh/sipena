...
=======
                <div class="col-6 text-end">
                    ...
                    <button class="btn bg-gradient-dark mb-0" data-bs-toggle="modal" id="addNewJabatanStatusBtn" data-bs-target="#createModal">
                       <i class="fas fa-plus"></i>&nbsp;&nbsp;Tambah Jabatan Status Baru
